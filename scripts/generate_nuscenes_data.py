...
from cross_view_transformer.data.transforms import LoadNuscenesDataTransform
from cross_view_transformer.common import setup_config, setup_nuscenes_data_module, setup_viz
...
def main(cfg):
    ...
    data = setup_nuscenes_data_module(cfg)
    viz_fn = None

    if 'visualization' in cfg:
        viz_fn = setup_viz(cfg)
        load_xform = LoadNuscenesDataTransform(cfg.data.dataset_dir, cfg.data.labels_dir,
