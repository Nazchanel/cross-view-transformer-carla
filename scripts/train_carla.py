...
from cross_view_transformer.common import setup_config, setup_carla_experiment, load_backbone
...
def main(cfg):
    ...
    ood_dataset = CarlaDatasetGenerated(cfg, json_file='ood_data.json')
    trainer.test(model_module, ood_dataset)
